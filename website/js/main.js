...
import { renderCsvAsTable, displayArticles } from './utils.js';
...
function populatePersonalInformation(personalData) {
    ...
    const interestsListElement = document.getElementById('interests');
...
function initializePageContent() {
    ...
    renderCsvAsTable("../static/author_data/awards.csv", 'awards-table');
    renderCsvAsTable("../static/author_data/education.csv", 'education-table');
    renderCsvAsTable("../static/author_data/professional_experience.csv", 'professional-table');
